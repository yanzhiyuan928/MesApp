// ignore_for_file: avoid_print, unnecessary_this, unused_element, avoid_unnecessary_containers
...
class ProductionPage extends StatefulWidget {
  ...
  @override
  State<ProductionPage> createState() => _ProductionState();
}

class _ProductionState extends State<ProductionPage> {
    ...
    return this
        ...
        .map((item) => Card(
              ...
              child: Column(
                children: [
                  ListTile(
                    title: Text('No: ' + item['No'].toString(),
                        style: const TextStyle(fontWeight: FontWeight.w500)),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Log: ' + item['ProductionLog']),
                      ],
                    ),
                  )
                ],
